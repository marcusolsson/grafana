...
Thanks for your interest in contributing to Grafana! We welcome all contributors who wants to participate in a healthy and constructive manner within our community. To help us create a safe and positive community experience for all, we require all participants to adhere to the [Code of Conduct](CODE_OF_CONDUCT.md).

This document is a guide to help you through the process of contributing to Grafana.

## Become a contributor

There are several ways to contribute to Grafana. Here are some examples:
...
Before submitting a new issue, try to make sure the problem hasn't already been reported. Look through the [existing issues](https://github.com/grafana/grafana/issues) for similar issues.
...
- [Beginner-friendly](https://github.com/grafana/grafana/issues?q=is%3Aopen+is%3Aissue+label%3A%22beginner+friendly%22) issues should only require changing a few lines.
- [Help wanted](https://github.com/grafana/grafana/issues?q=is%3Aopen+is%3Aissue+label%3A%22help+wanted%22) is assigned to issues that are a bit more involved than `beginner friendly` issues.
